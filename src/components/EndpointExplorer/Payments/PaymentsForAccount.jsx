...
export default class PaymentsForAccount extends PureComponent {
  render() {
    return (
      <div>
        <Title>PAYMENTS FOR ACCOUNT</Title>
        <Box padding="40px">
          <div className="row">
          ...
          <p className="m-2 mt-5">
            {
              'https://horizon-testnet.stellar.org/accounts/{account_id}/payments'
            }
          </p>
        </Box>
      </div>

...
export default class OperationsForTransactions extends PureComponent {
  render() {
    return (
      <div>
        <Title>OPERATION FOR TRANSACTION</Title>
        <Box padding="40px">
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-12">
              <h2 className="mt-2 font-weight-bold">TRANSACTION HASH</h2>
            </div>
            <InputContainerLarge
          ...
          <div className="row mt-5">
            ...
            <p className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              {
                'https://horizon-testnet.stellar.org/transactions/{transaction}/operations'
              }
            </p>
          </div>
        </Box>

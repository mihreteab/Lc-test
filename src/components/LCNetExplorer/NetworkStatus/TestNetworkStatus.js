...
class TestNetworkStatus extends Component {
  state = {
    status: {}
  }

  componentWillMount() {
    axios.get(`${IP_ADDRESS}/v1/Test/networkstatus`)
    .then(response => {
      this.setState({
    ...
    return (
      <NetworkStatusWrapper>
        <div style={{backgroundImage:`url(${Background})`}}>
          ...
          <BlackTitle>Test NETWORK STATUS</BlackTitle>
...
export default TestNetworkStatus;
